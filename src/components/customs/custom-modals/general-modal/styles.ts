...
export const generalModalVariants = cva([], {
  variants: {
    size: {
      xs: "max-w-[calc(100%-32px)] sm:max-w-[360px] w-full",
      sm: "max-w-[calc(100%-32px)] sm:max-w-[430px] w-full",
    ...
    type: {
      ...
      drawer: cn(
        ...
        "data-[state=closed]:-slide-out-to-right-full data-[state=closed]:slide-out-to-top-4",
