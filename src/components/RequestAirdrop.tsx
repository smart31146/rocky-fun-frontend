  ...
  return (
    <div className="flex flex-row justify-center">
      <div className="group relative items-center">
        ...
        <button
          type="button"
          className="btn m-2 animate-pulse bg-gradient-to-br from-indigo-500 to-fuchsia-500 px-8 text-white hover:from-white hover:to-purple-300"
          onClick={onClick}
        >
          <span>Airdrop Test </span>
        </button>
      </div>
    </div>
  )
